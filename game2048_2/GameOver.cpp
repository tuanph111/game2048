...
bool GameOver::loadGameOver(SDL_Renderer *renderer, SDL_Event *M_event) {
	loadBackGroundgameOver(renderer);
	bool running = true;
	while (running) {
...
void GameOver::loadBackGroundgameOver(SDL_Renderer *renderer) {
